...
TIPS = {
    "GOVERNANCA": "Formalize a política de privacidade, indique o Encarregado (Art. 41) e mantenha treinamento periódico.",
    "BASES_LEGAIS": "Defina a base legal e a finalidade de cada tratamento (Art. 7º e 11) e monte o registro de operações — ROPA (Art. 37).",
...
def computar(diagnostico):
    ...
    plano = [{"label": l["label"], "tip": TIPS.get(l["dimensao"], "")} for l in linhas if l["pct"] < 70]
